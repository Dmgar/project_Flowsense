...
export function PrivacyBadge() {
  ...
  return (
    <div className="pointer-events-auto absolute top-10 right-4 z-[500] flex items-center gap-2 rounded border border-border-subtle bg-bg-panel/80 px-2.5 py-1.5 font-mono text-[9px] text-text-muted backdrop-blur">
